# Telegram and Open Graph preview: DZEN REMONT v1

- Final asset: `public/og-dzen-remont-v1.jpg`
- Canvas: 1200 × 630 px, RGB JPEG
- Source card: `assets/og/og-dzen-remont-v1-source.png`
- Photo source: `assets/og/karpovka-source.jpg`, completed salon project on Karpovka
- Brand mark source: `public/brand/dzen-mark-512.png`
...
- Exact copy: `DZEN`, `REMONT`, `САНКТ-ПЕТЕРБУРГ`, `Ремонт коммерческих помещений под ключ`, `С 2012 года · 70+ проектов`, `Салоны · офисы · другие помещения`
